export const ipc_rj_ce =[
 {
   "cidade": "Rio de Janeiro (RJ)",
   "bairro": "Lagoa",
   "ipc": 0.7,
   "ClassificacaoIPC": "Muito Alto",
   "idh": 0.95,
